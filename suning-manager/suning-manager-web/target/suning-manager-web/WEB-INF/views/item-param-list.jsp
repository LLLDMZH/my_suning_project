...
<table class="easyui-datagrid" id="itemParamList" title="商品列表" 
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'created',width:130,align:'center',formatter:Suning.formatDateTime">创建日期</th>
            <th data-options="field:'updated',width:130,align:'center',formatter:Suning.formatDateTime">更新日期</th>
        </tr>
    </thead>
</table>
