 ...
 * Generated at: 2017-11-16 07:33:23 UTC
...
public final class item_002dparam_002dadd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t$(function(){\r\n");
      out.write("\t\t//选择类目结束后的一个回调\r\n");
      out.write("\t\tSuning.initItemCat({\r\n");
      out.write("\t\t\tFunction : function(node){\r\n");
      out.write("\t\t\t//将添加分组的按钮隐藏 并且将下面的参数给删除\r\n");
      out.write("\t\t\t$(\".addGroupTr\").hide().find(\".param\").remove();\r\n");
      out.write("\t\t\t  $.ajax({\r\n");
      out.write("\t\t\t\t   type: \"GET\",\r\n");
      out.write("\t\t\t\t   url: \"/item/param/template/\" + node.id,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t$.messager.alert('错误','创建失败!','error');\r\n");
      out.write("\t\t\t\t\t   }\r\n");
      out.write("\t\t\t\t   }\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\t\t\tvar groups = $(\"#itemParamAddTable [name=group]\");\t//获取所有名字叫做group的input\r\n");
      out.write("\t\t\t//一共两组数据\r\n");
      out.write("\t\t\tgroups.each(function(i,e){\r\n");
      out.write("\t\t\t\tvar p = $(e).parentsUntil(\"ul\").parent().find(\"[name=param]\");//根据当前的group找到最近的ul找到下面所有的paraminput\r\n");
      out.write("\t\t\t\tvar _ps = [];\r\n");
      ...
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t\tvar url = \"/item/param/template/\"+$(\"#itemParamAddTable [name=cid]\").val();\r\n");
