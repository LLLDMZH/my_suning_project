 ...
 * Generated at: 2017-11-22 02:46:04 UTC
...
public final class item_002dlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("       data-options=\"singleSelect:false,collapsible:true,pagination:true,url:'/item',method:'get',pageSize:30,toolbar:toolbar\">\r\n");
      out.write("    <thead>\r\n");
      out.write("        <tr>\r\n");
      ...
      out.write("            <th data-options=\"field:'price',width:70,align:'right',formatter:Suning.formatPrice\">价格</th>\r\n");
      out.write("            <th data-options=\"field:'number',width:70,align:'right'\">库存数量</th>\r\n");
      out.write("            <th data-options=\"field:'barcode',width:100\">条形码</th>\r\n");
      out.write("            <th data-options=\"field:'status',width:60,align:'center',formatter:Suning.formatItemStatus\">状态</th>\r\n");
      out.write("            <th data-options=\"field:'createdTime',width:130,align:'center',formatter:Suning.formatDateTime\">创建日期</th>\r\n");
      out.write("            <th data-options=\"field:'updatedTime',width:130,align:'center',formatter:Suning.formatDateTime\">更新日期</th>\r\n");
      out.write("        </tr>\r\n");
      out.write("    </thead>\r\n");
      out.write("</table>\r\n");
      out.write("<!-- 窗口中的内容显示href的内容 -->\r\n");
      ...
      out.write("    \t//返回一个json数组\r\n");
      out.write("    \tvar selected = itemList.datagrid(\"getSelections\");\r\n");
      out.write("    \tvar ids = [];\r\n");
      out.write("    \tfor(var i in selected){\r\n");
      ...
      out.write("        \t\t\t//显示价格。\r\n");
      out.write("        \t\t\tdata.priceView = Suning.formatPrice(data.price);\r\n");
      out.write("        \t\t\t//EasyUI加载表单\r\n");
      out.write("        \t\t\t$(\"#itemeEditForm\").form(\"load\",data);\r\n");
      out.write("        \t\t\r\n");
      out.write("        \t\t\t// 加载商品描述\r\n");
      out.write("        \t\t\r\n");
      out.write("        \t\t\t$.getJSON('/item/description/'+data.id,function(_data){\r\n");
      out.write("        \t\t\t\titemEditEditor.html(_data.itemDescription);\r\n");
      out.write("        \t\t\t});\r\n");
      out.write("        \t\t\t\r\n");
      out.write("        \t\t\t//加载商品规格数据\r\n");
      out.write("        \t\t\t$.getJSON('/item/param/data/'+data.id,function(_data){\r\n");
      ...
      out.write("        \t\t\t});\r\n");
      out.write("        \t\t\tSuning.init({\r\n");
      out.write("        \t\t\t\t\"pics\" : data.image,\r\n");
      out.write("        \t\t\t\t\"cid\" : data.cid,\r\n");
      out.write("        \t\t\t\t\"dom\" : this,\r\n");
      out.write("        \t\t\t\tFunction:function(node){\r\n");
      out.write("        \t\t\t\t\tSuning.changeItemParam(node, \"itemeEditForm\");\r\n");
      out.write("        \t\t\t\t}\r\n");
      out.write("        \t\t\t});\r\n");
      out.write("        \t\t}\r\n");
