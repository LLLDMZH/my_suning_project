...
<table class="easyui-datagrid" id="itemList" title="商品列表" 
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'price',width:70,align:'right',formatter:Suning.formatPrice">价格</th>
            <th data-options="field:'number',width:70,align:'right'">库存数量</th>
            <th data-options="field:'barcode',width:100">条形码</th>
            <th data-options="field:'status',width:60,align:'center',formatter:Suning.formatItemStatus">状态</th>
            <th data-options="field:'createdTime',width:130,align:'center',formatter:Suning.formatDateTime">创建日期</th>
            <th data-options="field:'updatedTime',width:130,align:'center',formatter:Suning.formatDateTime">更新日期</th>
        </tr>
    </thead>
</table>
<!-- 窗口中的内容显示href的内容 -->
        ...
        handler:function(){
        	...
        	$("#itemEditWindow").window({
        		onLoad :function(){
        			...
        			//显示价格。
        			data.priceView = Suning.formatPrice(data.price);
        			//EasyUI加载表单
        			$("#itemeEditForm").form("load",data);
        		
        			// 加载商品描述
        		
        			$.getJSON('/item/description/'+data.id,function(_data){
        			...
        			Suning.init({
        				...
        				Function:function(node){
        					Suning.changeItemParam(node, "itemeEditForm");
        				}
        			});
        		}
        	}).window("open");
