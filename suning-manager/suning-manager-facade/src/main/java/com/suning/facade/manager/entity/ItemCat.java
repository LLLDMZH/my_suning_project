...
@Table(name = "sunning_shopping_itemcat")
public class ItemCat extends BaseEntity{
    /**
	 * 
	 */
	private static final long serialVersionUID = -3546788107545159963L;
	...
	public String toString() {
		return "ItemCat [id=" + id + ", parentId=" + parentId + ", itemName="
				+ itemName + ", isParent=" + isParent + ", sortOrder="
				+ sortOrder + ", status=" + status + ", toString()="
				+ super.toString() + "]";
	}
